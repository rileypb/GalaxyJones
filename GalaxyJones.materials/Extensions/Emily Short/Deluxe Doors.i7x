...
Rule for reaching inside a room when the particular possession is something and the particular possession is part of an open door (called target) (this is the arrange scope for partial doors rule):	
	say "1.";
